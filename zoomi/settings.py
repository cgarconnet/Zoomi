# -*- coding: utf-8 -*-
"""
Django settings for zoomi project.
...
SECRET_KEY = 'q%aveo0!0w8#e6muk(m(v8w+-@arjxle50#g(spb1n9o$v4mux'
...
WSGI_APPLICATION = 'zoomi.wsgi.application'
